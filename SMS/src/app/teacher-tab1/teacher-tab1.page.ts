...
@Component({
  selector: 'app-teacher-tab1',
  templateUrl: './teacher-tab1.page.html',
  styleUrls: ['./teacher-tab1.page.scss'],
})
export class TeacherTab1Page implements OnInit {
  ...
  search() {
    ...
    this.gridlist = [];
    let apiUrl = `${this.serviceBaseUrl}api/Course/GetCourseUserDetail?COURSEID=${this.course1.ID}`;
